...
#tried to refactor my method with i = 0 as a counter, if key == values[i] // new_array << keys[i]... i += 1 outside of if loops... but can't get it working.... 
# class Hash
...
# 
#     arguments.each do |key, value| ## first key == "Panama", value == nil
#       #binding.pry
#       #arguments == ["Panama"] // first arguments
...
#       #key = "Panama" #in first iteration of loop, value = "nil"
# 
